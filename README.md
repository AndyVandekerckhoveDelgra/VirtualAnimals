...
(De microservice interageren met elkaar door elkaars localhost te gebruiken in de hun code en gegevens op te halen waar nodig. U moeten voor deze functie ten minste dus de "animal" service en de "adopted animal" service open laten staan, samen met de "operation" service, zodat het functie werkt.)
...
(De microservice interageren met elkaar door elkaars localhost te gebruiken in de hun code en gegevens op te halen waar nodig. U moeten voor deze functie ten minste dus de "food" service en de "adopted animal" service open laten staan, samen met de "operation service", zodat het functie werkt.)
